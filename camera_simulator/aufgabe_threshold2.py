...
try:
    ...
    while True:
        ...
        _, frame_schwarz_weiss1 = cv2.threshold(frame_graustufen, 110, 255, cv2.THRESH_BINARY_INV)
        frame_schwarz_weiss2 = cv2.adaptiveThreshold(frame_graustufen, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 11, 9)
        frame_schwarz_weiss3 = cv2.adaptiveThreshold(frame_graustufen, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 11, 6)
