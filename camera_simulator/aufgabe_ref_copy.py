"""
Demonstriert Referenzen vs. Kopien.
...
try:
    ...
    while True:
        ...
        # dieser_frame 1x verfärben
        dieser_frame = dieser_frame + 100
        # noch 1x verfärben und in heller speichern
        heller = dieser_frame + 100
        # untere Hälfte aus kopie herausschneiden
        unterer_teil = kopie[int(PIXEL_HOEHE/2):,:,:]
