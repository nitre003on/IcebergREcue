"""
Demonstriert das dilate()-Feature.
...
try:
    ...
    while True:
        ...
        _, frame_schwarz_weiss = cv2.threshold(frame_graustufen, 100, 255, cv2.THRESH_BINARY_INV)

        # „Scan-Bereich“ auf 5x5 Pixel einstellen
        kernel = numpy.ones((5, 5), numpy.uint8)
        # 3x jeweils 5 Pixel an alle Kanten dranpappen:
