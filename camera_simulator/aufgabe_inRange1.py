...
try:
    ...
    while True:
        ...
        # Maske für:
        # alle Farbtöne
        # geringe Sättigung (weiß/grau/schwarz)
        # geringe bis mittlere Helligkeit
        #                                H  S  V
        untere_schwelle = numpy.uint8([0, 0, 0])
        obere_schwelle = numpy.uint8([255, 60, 130])
        #
        schwarz_maske = cv2.inRange(frame_als_hsv, untere_schwelle, obere_schwelle)

        # Kamerabild anzeigen
        cv2.imshow("Maze Runner", schwarz_maske)
