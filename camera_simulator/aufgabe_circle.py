...
try:
    ...
    while True:
        ...
        zentrum1 = (int(radius), int(radius))
        zentrum2 = (int(radius), int(PIXEL_HOEHE - 1 - radius))
        zentrum3 = (int(PIXEL_BREITE - 1- radius), int(radius))
        zentrum4 = (int(PIXEL_BREITE - 1- radius), int(PIXEL_HOEHE - 1 - radius))
        cv2.circle(dieser_frame, zentrum1, radius, GRUEN, 2)
        cv2.circle(dieser_frame, zentrum2, radius, GRUEN, 2)
        cv2.circle(dieser_frame, zentrum3, radius, GRUEN, 2)
        cv2.circle(dieser_frame, zentrum4, radius, GRUEN, 2)
