"""
Demonstriert die Konvertierung von BGR in HSV
und die anschließende Binarisierung an 2 Schwellenwerten (aka Maskierung).
...
Ist die Mehrheit eines Bereichs über grün, wird das Rechteck grün dargestellt.
...
try:
    ...
    while True:
        ...
        roi_links = gruen_maske[start1[1]:ende1[1], start1[0]:ende1[0]]
        # Rechteck von oben links (x=200, y=100) bis unten rechts (x=250, y=150) ausschneiden:
        roi_rechts = gruen_maske[start2[1]:ende2[1], start2[0]:ende2[0]]
