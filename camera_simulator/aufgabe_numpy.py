"""
Demonstriert den Umgang mit numpy Arrays.
...
try:
    ...
    while True:
        ...
        ####################################
        # Hälfte des Bildes abschneiden
        ####################################
        # PIXEL_HOEHE/2 ergibt eine Gleitkommazahl (float).
        # Das ist als Array-Index aber nicht erlaubt, weswegen
        # das Ergebnis mittels int() in eine Ganzzahl konvertiert wird.
